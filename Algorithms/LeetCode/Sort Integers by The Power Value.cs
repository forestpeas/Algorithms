...
namespace Algorithms.LeetCode
{
     ...
     * which is 13. Notice that 12 and 13 have the same power value and we sorted them in ascending
    ...
    public class Sort_Integers_by_The_Power_Value
    {
        ...
        {
            // Brute-force.
            // We can optimize the solution by saving the computed powers of seen numbers.
            return Enumerable
                .Range(lo, hi - lo + 1)
                .Select(num =>
                {
