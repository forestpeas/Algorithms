...
namespace Algorithms.LeetCode
{
     ...
     * 
     * Return a lucky integer in the array. If there are multiple lucky integers return the largest
     * of them. If there is no lucky integer return -1.
     * 
     * Example 1:
     * 
     * Input: arr = [2,2,3,4]
    ...
    public class Find_Lucky_Integer_in_an_Array
    {
        public int FindLucky(int[] arr)
        {
            ...
            foreach (int num in arr)
            {
                if (num == counts[num]) res = Math.Max(res, num);
            }
            return res;
        }
    }
