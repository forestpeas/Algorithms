...
namespace Algorithms.LeetCode
{
     ...
     * 
     * You are given two arrays of integers nums1 and nums2, possibly of different lengths. The values in the
     * arrays are between 1 and 6, inclusive.
     * 
     ...
     * Output: -1
     * Explanation: There is no way to decrease the sum of nums1 or to increase the sum of nums2 to make them
     * equal.
     * 
     * Example 3:
     * 
