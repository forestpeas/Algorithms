...
namespace Algorithms.LeetCode
{
     ...
     * 
     *     1. FindSumPairs(int[] nums1, int[] nums2) Initializes the FindSumPairs object with two integer
    ...
    public class Finding_Pairs_With_a_Certain_Sum
    {
        public class FindSumPairs
        {
            ...
            private readonly Dictionary<int, int> nums2Counts = new Dictionary<int, int>();
            ...
            public FindSumPairs(int[] nums1, int[] nums2)
            {
                ...
                {
                    nums2Counts[num2] = nums2Counts.GetValueOrDefault(num2) + 1;
                }
            }

            public void Add(int index, int val)
            {
                nums2Counts[nums2[index]]--;
                nums2[index] += val;
                nums2Counts[nums2[index]] = nums2Counts.GetValueOrDefault(nums2[index]) + 1;
            }
            ...
            public int Count(int tot)
            {
                ...
                {
                    res += nums2Counts.GetValueOrDefault(tot - num1);
                }
                return res;
            }
        }
